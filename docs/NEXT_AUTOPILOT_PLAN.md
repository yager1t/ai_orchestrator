...
- [ ] Record ADR-0004 for the autopilot queue and batch execution model covering persisted plan queues, loop mode, worktree isolation, approvals/blockers, and per-run reports.
