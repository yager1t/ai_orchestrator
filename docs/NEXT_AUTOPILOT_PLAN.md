...
- [ ] Add `ai-orch autopilot queue sync/list` commands that load Markdown plan items into the persisted queue without duplicates and display queue status without running batch execution.
