...
- [ ] Record ADR-0005 for optional per-task worktree rotation in autopilot batch runs, covering the CLI contract, safety guardrails, stop conditions, and deferred automation.
