...
- [ ] Add the first persisted autopilot queue model slice: SQLite schema, StateStore helpers, and tests for recording and listing plan items without batch execution.
