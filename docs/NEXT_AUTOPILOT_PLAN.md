...
- [ ] Add the first ADR-0005 implementation slice: `ai-orch autopilot queue run-batch --rotate-worktrees BASE_DIR` dry-run selection and validation, mutually exclusive with `--worktree`, without executing tasks in rotated worktrees yet.
